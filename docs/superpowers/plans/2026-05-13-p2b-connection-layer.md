...
vip_manager_dcs_endpoints: >-
  ...
  {%- endfor %}]
vip_manager_dcs_cacert: "{{ pigsty_pki_dir | default('/etc/pki/pigsty') }}/ca.crt"
vip_manager_dcs_cert: "{{ pigsty_pki_dir | default('/etc/pki/pigsty') }}/{{ inventory_hostname }}.crt"
vip_manager_dcs_key:  "{{ pigsty_pki_dir | default('/etc/pki/pigsty') }}/{{ inventory_hostname }}.key"
